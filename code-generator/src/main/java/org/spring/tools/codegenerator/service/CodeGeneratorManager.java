...
import org.spring.tools.codegenerator.service.impl.ServiceGenerator;
...
public class CodeGeneratorManager extends CodeGeneratorConfig {
    ...
    private static Properties loadProperties() {
        ...
        try {
            prop = new Properties();
            InputStream in = CodeGeneratorManager.class.getClassLoader().getResourceAsStream("xml/generatorConfig.properties");
            prop.load(in);
        } catch (Exception e) {
